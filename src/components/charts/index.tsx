...
export default function ChartsContainer() {
    ...
    return (
        ...
        `} >
            ...
            <div className="card-header flex justify-between p-4 border-b">
                <h2 className="card-title text-lg">{selectedSatellite ? `${selectedSatellite}` : 'No satellite selected'}</h2>
                <svg
                    onClick={() => {
                        dispatch(closeCharts());
                    }}
                    xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6 cursor-pointer hover:opacity-70">
